...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pending_text.setPlaceholderText(_translate("Form",
                                                        "本软件主要基于handwrite库开发，仅供学习交流。作者只是一名为手写作业发愁的大学生，想要源码或者想要添加功能、反馈bug的，可以联系作者b站：人走茶凉le"))
...
#
#
# class cus_listmodel(QtCore.QAbstractListModel):
#     def __init__(self):
#         super().__init__()
#         self.datalist = {}
#
...
#         '''
#         :param parent: parent:PySide2.QtCore.QModelIndex=...
#         :return: int
#         '''
...
#         '''
#         :param index: :PySide2.QtCore.QModelIndex
#         :param role: int
#         :return: -> typing.Any
#         '''
#         row = index.row()
...
#         tmp_data = self.datalist[row]
#         if role == Qt.UserRole+1:
#             tmp_data.bl = value.toBool()
#             res = True
#
#         elif role == Qt.UserRole+2:
#             tmp_data.txt = value.toString()
#         self.datalist[row] = tmp_data
#         return res
#
#
# class cus_detegat(QtWidgets.QStyledItemDelegate):
#     def __init__(self):
#         super().__init__()
#
#     def paint(self, painter, option, index):
#         '''
#         :param painter: :PySide2.QtGui.QPainter
#         :param option: :PySide2.QtWidgets.QStyleOptionViewItem
#         :param index: :PySide2.QtCore.QModelIndex
#         :return:
#         '''
#         rec = option.rect
#         bol = index.data(Qt.UserRole+1).toBool()
#         text = index.data(Qt.UserRole+1).toString()
#         viewoption = QtWidgets.QStyleOptionViewItem(option)
#         viewoption.init(index)
#         if option.state
#
#
#         '''
...
#         '''
#         :param editor: :PySide2.QtWidgets.QWidget
#         :param index: :PySide2.QtCore.QModelIndex
#         :return:
#         '''
#         pass
#
# class my_win(QtWidgets.QWidget):
#     def __init__(self):
#         super().__init__()
#         self.initUI()
#
...
#
#         self.listmod = cus_listmodel()
#         self.listview.setModel(self.listmod)
#         self.delegate = cus_detegat()
